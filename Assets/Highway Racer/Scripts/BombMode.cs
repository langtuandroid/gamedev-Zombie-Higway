...
public class BombMode : MonoBehaviour
{
    ...
    private AudioClip bombTimerAudioClip
    {
        get { return HR_HighwayRacerProperties.Instance.bombTimerAudioClip; }
    }

    void Start()
    {
        handler = GetComponentInParent<HR_PlayerHandler>();
        bombTimerAudioSource = RCC_CreateAudioSource.NewAudioSource(gameObject, "Bomb Timer AudioSource", 0f, 0f, .25f,
