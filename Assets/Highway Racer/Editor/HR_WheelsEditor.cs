...
[CustomEditor(typeof(WheelCollection))]
public class HR_WheelsEditor : Editor {

	WheelCollection prop;

	Vector2 scrollPos;
	List<WheelCollection.Wheels> playerCars = new List<WheelCollection.Wheels>();
	...
	void AddNewWheel(){
		...
		WheelCollection.Wheels newCar = new WheelCollection.Wheels();
