...
//	}
	...
	public override void OnInspectorGUI (){
		...
		upgradableWheels = new GameObject[WheelCollection.Instance.wheels.Length];
		
		for (int i = 0; i < upgradableWheels.Length; i++) {
			upgradableWheels[i] = WheelCollection.Instance.wheels[i].wheel;
			EditorGUILayout.BeginVertical(GUI.skin.box);
		...
		if(GUILayout.Button("Configure Upgradable Wheels")){
			Selection.activeObject = Resources.Load("HR_Assets/WheelCollection") as WheelCollection;
		}
